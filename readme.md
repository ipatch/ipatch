...
testing formula using `brew install` is **maddening**, why?

- verifying the checksum for an already downloaded tarball takes a **considerable** amount of time.
- not being able to use the existing cmake build dirs with the `--keep-tmp` arg provided by brew is **maddening** as well.
